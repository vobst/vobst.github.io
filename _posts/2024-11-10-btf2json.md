...
_Note:_ For the evaluation, we used Volatility3 at commit `a00a59cd235cb18b7dc28ccf2669e2a82368fab5`, `btf2json` at commit `TODO`, and `dwarf2json` at commit `9f14607e0d339d463ea725fbd5c08aa7b7d40f75`.
...
- **Extract kallsyms from the image**, either
    - using a carving approach like `vmlinux-to-elf` (conceptually simple, loooots of work),
